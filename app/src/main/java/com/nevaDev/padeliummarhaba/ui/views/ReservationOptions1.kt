                                ...
                                Card(
                                    modifier = Modifier
                                        ...
                                        .clickable {
                                            ...
                                            Log.d("SelectedBooking", "Updated List of Selected Bookings:")


                                            Log.d("SelectedBooking", "Updated List of Selected Bookings:")
                                            bookingViewModel.selectedBookings.forEach { booking ->
                                                Log.d("SelectedBooking", "Establishment: ${booking.establishmentDTO?.name}, Amount: ${booking.amount}, Currency: ${booking.currencySymbol}, From: ${booking.from}, To: ${booking.to}")
                                    ...
                                    Row(
                                        ...
                                        Button(
                                            onClick = {
                                                Log.d("ButtonClick", "Button was clicked") // To ensure onClick is triggered
/*
                                                selectedReservation = ReservationOption(
                                                    name = establishmentName,
                                                    time = "${planning.fromStr} ${planning.toStr}",
