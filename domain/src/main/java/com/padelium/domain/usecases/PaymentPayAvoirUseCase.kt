...
class PaymentPayAvoirUseCase @Inject constructor(private val paymentPayAvoirrepository: IPaymentPayAvoirrepository) {
    ...
    suspend fun PaymentPayAvoir(amount: BigDecimal): DataResult {
        return try {
            ...
            if (response.isSuccessful) {
                Log.e("TAG", "PaymentPayAvoir result: ${response.code()}")
