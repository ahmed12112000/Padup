...
data class EstablishmentPacksDTO1(
    val name:String,
...
data class EstablishmentPictureDTO1(
    val id: Long?,
    val description: String?,
...
data class establishmentFeatureDTO1(
    val id:Long,
    val created: Instant,
    val updated: Instant,
    val createdBy: Long,
...
data class bookingAnnulationDTO1(
    val id: Long,
    val label:String,
...
data class bookingUsersPaymentDTO1(
    val id: Long,
    val code: String,
    val isactive:Boolean,
    val description: String,
...
data class establishmentSearchDTO1(
    val dateTime: String,
    val activityId: Long,
    val cityId: Long,
    val activityName: String,
