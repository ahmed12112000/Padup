...
class PrivateExtrasMapper @Inject constructor() {
    ...
    fun PrivateExtrasRequestToPrivateExtrasResponseDTO(privateextrasResponse: List<PrivateExtrasResponseDTO>): List<PrivateExtrasResponse> {
        return privateextrasResponse.map { response ->
